...
function HeroSection() {
    return (
        <div className="grid grid-cols-1 sm:max-lg:grid-rows-2 sm:max-lg: lg:grid-cols-7 lg:gap-8 content-center w-full h-screen font-popins relative bg-primary">
            ...
            <div className="lg:h-screen lg:max-xl:pt-20 justify-center xl:grid flex flex-col-reverse lg:flex-col-reverse lg:justify-center sm:flex-row-reverse sm:justify-around lg:col-span-3 sm:max-xl:py-8 sm:bg-secondary place-items-center relative">
                <div className="flex flex-col gap-2 sm:gap-2 lg:gap-4 items-center z-[2]">
                    <h3 className="text-secondary sm:text-white text-3xl md:text-4xl lg:text-[2.5rem] drop-shadow-md font-bold">Sony Headeset</h3>
                    <h5 className="text-secondary sm:text-white text-2xl lg:text-3xl font-bold">₹12,990  <span className="line-through">₹24,990</span></h5>
                    <Button title="Add to Cart" className={`max-sm:!bg-secondary max-sm:!text-white`} />
                </div>
